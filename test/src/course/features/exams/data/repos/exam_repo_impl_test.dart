...
import 'package:educational_app/src/course/features/exams/data/repos/exam_repo_impl.dart';
...
void main() {
  ...
  group('getExamQuestions', () {
    test(
      'should return [List<ExamQuestion>] when call to remote source '
      'is successful',
      () async {
        when(
  ...
  group('getExams', () {
    test(
        'should return [List<Exam>] when call to remote source '
        'is successful', () async {
      when(
  ...
  group('getUserCourseExams', () {
    test(
        'should return [List<UserExam>] when call to remote source '
        'is successful', () async {
      when(
  ...
  group('submitExam', () {
    test(
        'should complete successfully when call to remote source '
        'is successful', () async {
      when(
        () => remoteDataSrc.submitExam(any()),
