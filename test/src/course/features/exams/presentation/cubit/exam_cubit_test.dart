...
import 'package:educational_app/src/course/features/exams/domain/usecases/get_exam_questions.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/get_exams.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/get_user_course_exam.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/get_user_exams.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/submit_exam.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/update_exam.dart';
import 'package:educational_app/src/course/features/exams/domain/usecases/upload_exam.dart';
import 'package:educational_app/src/course/features/exams/presentation/cubit/exam_cubit.dart';
...
void main() {
  ...
  group('getExams', () {
    ...
    blocTest<ExamCubit, ExamState>(
      ...
      build: () {
        when(
          () => getExams(any()),
        ).thenAnswer((_) async => Right(tExams));
        return cubit;
      },
  ...
  group('getUserCourseExams', () {
    ...
    final tUserExams = [
      UserExamModel.empty(),
      UserExamModel.empty().copyWith(examId: '1'),
    ];
    blocTest<ExamCubit, ExamState>(
      'should emit [GettingUserExams, UserCourseExamsLoaded] when successful',
      build: () {
        when(
          () => getUserCourseExams(any()),
        ).thenAnswer((_) async => Right(tUserExams));
        return cubit;
      },
