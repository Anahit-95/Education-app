...
import 'package:educational_app/core/common/widgets/titled_input_field.dart';
...
// https://assets.stickpng.com/images/62b22391038aad4d3ed7ca37.png
// https://cdn-images-1.medium.com/v2/resize:fit:1200/1*knHF_gpxdS8h0Z8EeqowA.png
    ...
    return BlocListener<CourseCubit, CourseState>(
      listener: (_, state) {
        if (state is CourseError) {
          ...
          Navigator.pop(context);
          // CoreUtils.showLoadingDialog(context);
          // TODO(AddCourse): Send Notifications
        }
      },
      child: Padding(
