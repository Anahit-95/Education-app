...
import 'package:educational_app/src/course/features/exams/presentation/app/providers/exam_controller.dart';
import 'package:educational_app/src/course/features/exams/presentation/widgets/exam_navigation_blob.dart';
              ...
              final result = await showDialog<bool>(
                ...
                builder: (context) {
                  return AlertDialog.adaptive(
                    ...
                    content: const Text('Are you sure you want to exit exam'),
                    actions: [
                      TextButton(
                        onPressed: () {
                          Navigator.pop(context, false);
