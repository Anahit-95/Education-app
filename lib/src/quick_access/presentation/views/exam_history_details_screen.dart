...
import 'package:educational_app/src/quick_access/presentation/widgets/exam_history_answer_tile.dart';
import 'package:educational_app/src/quick_access/presentation/widgets/exam_history_tile.dart';
...
class ExamHistoryDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('${exam.examTitle} Details'),
      ),
      body: SafeArea(
        child: Padding(
